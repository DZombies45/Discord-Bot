        ...
        .then(async data => {
            try {
                ...
                if (latestBedrockPreview && !bedrockPreviews) {
                    ...
                    const version = Utils.getMCVersion(
                        latestBedrockPreview.name
                    );
                    const thumbnail = Utils.extractImage(
                        latestBedrockPreview.body
                    );
