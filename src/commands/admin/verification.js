    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(sub =>
            sub
                .setName("configure")
                .setDescription(
                    "[admin] configure verification system on the server"
                )
        ...
        .addSubcommand(sub =>
            sub
                .setName("remove")
                .setDescription(
                    "[admin] remove verification system on the server"
                )
        )
        .toJSON(),
            ...
            case "configure":
                ...
                if (!dataDB) {
                    ...
                    embed
                        ...
                        .setDescription(
                            "verification system successfuly created."
                        )
                        .addFields({
                            name: "verify channel",
                            value: verifyChannel,
                    ...
                    embed
                        .setColor(mConfig.embedColorSuccess)
                        .setDescription(
                            "verification system successfuly edited."
                        )
                        .addFields({
                            name: "verify channel",
                            value: verifyChannel,
